...
import { Activity, Compass, Rocket, Wallet, Zap, Home } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
      ...
      <SidebarHeader className="border-b border-sidebar-border px-3 py-4">
        <Link to="/" className="flex items-center gap-2">
          ...
          <div className="flex flex-col leading-none">
            <span className="font-display text-sm font-bold tracking-tight">AGENTPIT</span>
      ...
      <SidebarFooter className="border-t border-sidebar-border p-3">
        <div className="flex items-center gap-2 rounded-md bg-sidebar-accent px-2 py-2">
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="ticker text-xs">0x7a3f…b21c</span>
          </div>
        </div>
      </SidebarFooter>
    </Sidebar>
